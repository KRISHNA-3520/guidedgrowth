...
export default function CTA() {
  ...
  return (
    <section className="py-28 text-foreground relative overflow-hidden" ref={ref} style={{ background: 'linear-gradient(oklch(0.972 0.008 85) 0%, oklch(0.91 0.018 80) 100%)' }}>
